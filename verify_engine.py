        ...
        for intent_name, intent_data in self.intents.items():
            ...
            for pattern in patterns:
                if pattern.search(text):
                    ...
                    break
            # Keyword matching (supports both "keywords" and "keywords_zh")
            if score < 0.95:
                keywords = intent_data.get("keywords_zh", intent_data.get("keywords", []))
...
#  Module 1: TaskProfiler (v3.2 NLU integrated)
# ============================================================
...
def run_tests():
    ...
    check_in("sms tool detected", "sms", p1["tools_required"])
    ...
    check_eq("nlu sms match_method", nlu_result1["match_method"], "pattern")
    ...
    check_in("nlu profiler office (keyword)", "office", p_nlu5["tools_required"])
